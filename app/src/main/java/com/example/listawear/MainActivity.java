...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.flutter, "Cthulhu", "Dios Primigenio "));
        items.add(new ItemsList(R.mipmap.java, "Azathoth", "La deidad más poderosa"));
        items.add(new ItemsList(R.mipmap.cplus, "Nyarlathotep", "Dios Exterior "));
        items.add(new ItemsList(R.mipmap.php, "Hastur", "Dios Primigenio"));
        items.add(new ItemsList(R.mipmap.javascript, "Yog-Sothoth", "Dios Primigenio"));
